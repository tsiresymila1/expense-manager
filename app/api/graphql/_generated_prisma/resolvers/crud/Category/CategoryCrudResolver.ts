...
export class CategoryCrudResolver {
  ...
  async createManyAndReturnCategory(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyAndReturnCategoryArgs,
  ): Promise<CreateManyAndReturnCategory[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async createOneCategory(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneCategoryArgs,
  ): Promise<Category> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneCategory(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneCategoryArgs,
  ...
  async findFirstCategoryOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstCategoryOrThrowArgs,
  ): Promise<Category | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getCategory(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueCategoryOrThrowArgs,
  ): Promise<Category | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneCategory(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneCategoryArgs,
  ): Promise<Category | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneCategory(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneCategoryArgs,
  ): Promise<Category> {
    const { _count } = transformInfoIntoPrismaArgs(info);
